...
const DemoLoginButton: React.FC<DemoLoginButtonProps> = ({ onSuccess, onError }) => {
  ...
  const handleDemoLogin = async () => {
    ...
    try {
      ...
      const errorMessage =
        error instanceof Error ? error.message : '데모 계정 로그인 중 오류가 발생했습니다.';
  ...
  return (
    <TouchableOpacity
      style={[styles.demoButton, isLoading && styles.demoButtonPressed]}
    ...
    >
      ...
      <Text style={[styles.demoText, isLoading && styles.loadingText]}>
