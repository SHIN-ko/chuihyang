...
- **레시피 + 타입 선택 시스템**
   ...
   - **레시피별 브랜드 컬러**: UI에서 프로젝트 카드, 진행률 바, 아이콘 등에 활용
...
각 레시피별로 고유한 브랜드 컬러를 사용하여 UI에서 시각적 구분을 제공합니다.

### 컬러 팔레트:
- **야레야레** (전통 레시피): `#025830` 
  - 깊은 녹색, 전통과 자연을 상징
- **블라블라** (허브 레시피): `#20407c`
  - 진한 청색, 허브의 시원함과 신선함을 표현
- **오즈** (진한 맛 레시피): `#ab1e4b`
  - 진한 분홍색, 강렬하고 깊은 맛을 상징
- **파친코** (과일 레시피): `#eaa728`
  - 따뜻한 주황색, 과일의 달콤함과 활력을 표현
- **계애바** (클래식 레시피): `#921e22`
  - 진한 빨간색, 클래식한 품격과 깊이를 상징
